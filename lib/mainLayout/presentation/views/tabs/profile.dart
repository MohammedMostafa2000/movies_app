                              ...
                              children: [
                                Column(
                                  children: [
                                    CircleAvatar(
                                      radius: 58.r,
                                      backgroundImage: AssetImage(avatarsList[
                                          (viewModel.user?.avatarId ?? 1) - 1]),
                                    ),
                                    ...
                                    itemBuilder: (context, index) => MovieCard(
                                      onTap: () async {
                                        final result =
                                          ...
                                          arguments:
                                              viewModel.favoritesList[index].id,
                                        );
