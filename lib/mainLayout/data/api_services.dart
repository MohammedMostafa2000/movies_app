...
class ApiServices {
  static Future<Either<List<MovieDataModel>, String>> getMovies({String genre='', int limit=10,String sortedBy=''}) async {
    try {
      final url = Uri.parse('https://yts.mx/api/v2/list_movies.json?genre=$genre&limit=$limit&sort_by=$sortedBy');
